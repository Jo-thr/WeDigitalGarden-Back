...
class UseCaseWithLangResource extends JsonResource
{
    /**
     ...
     *                  type="object",
     *                  required={"title_satisfaction", "section_color", "comment", "auteur", "poste_auteur"},
     ...
     *                  @OA\Property(property="section_color", type="string", description="The sectionColor of use case ", example="lorem-ipsum"),
     ...
     *                  @OA\Property(property="poste_auteur", type="string", description="The poste_auteur of use case", example="{'description': 'poste_auteur of use case'}"),
     *              ),
     *     ),
     *     @OA\Property(
     *          property="links",
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'links' => [
                'self' => route('use-case.id.lang', ['id' => $this->id, 'lang' => last(request()->segments())])
            ]
        ];
    }
}
